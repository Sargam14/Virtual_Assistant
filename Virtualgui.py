...
class Widget():
    ...
    name = ['You Can call me VivaVox','My Name Is VivaVox','you named me VivaVox','You Should Know this, My name Is VivaVox']
    ...
    frd = ['I will Feel Lucky To Be Your Friend','Yaa Ofcourse']
    ...
    #---------------------------PRINTING FUNC---------------------------------------------------
    #       THIS FUCTION PRINTS THE RIMSAR RESPONCE TO SCREEN.
    #---------------------------------------------------------------------------------------------------
    ...
    #-----------------SPEAK FUNCTION-------------------------------
    #    THIS FUNCTION SPEAKS THE RIMSAR RESPONCE
    #------------------------------------------------------------------------
    def speak(self,s):
        self.engine.say(s)
    ...
    #-----------------------SEND FUNC-----------------------------------------------------------------
    #        THIS FUCTION IS BEING USED TO SEND USER_INPUT TO RIMSAR.
    #--------------------------------------------------------------------------------------------------------
    def send_func(self):
    ...
    #-------------------------------------------------------------------------------------------------------
        ...
        #------------------------------------CONDITIONS------------------------------------------------------------------------------------------
        # THESE ARE CONDITIONS WHICH THE RIMSAR. CHECKS. HE RESPOND TO THE MOST RELEVENT CONDITION.
        #-------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        #-----------------GURPARTAP CONDITION-------------------------------------------------------------------
            ...
            out = 'Rimsha Is A Good Friend Of Sargam.'                                                                                                  
            self.printing_func(out)                                                                                    
            self.speak(out)
        #-----------------------------------------------------------------------------------------------------------------------
       ...
       #--------------------------THANKS CONDITION-------------------------------------------------------   
        ...
        #-----------------------------GOOD MORNING CONDITION--------------------------------------------------------------------------------
            ...
            try:     
                url='http://api.openweathermap.org/data/2.5/weather?appid=0c42f7f6b53b244c78a418f4f181282a&q=Aligarh'
            ...
            out = f'Good Morning , The Current Time is {time},  And {outa},    Have A Good Day!'
            self.printing_func(out)
            self.speak(out)
        #--------------------------------------------------------------------------------------------------------------------------------------------------------            
        ...
        #----------EXIT CONDITION------------------------
            ...
            out = 'Okk I am going, Have a good Day!'  
            self.printing_func(out)                                             
            self.speak(out)                                                             
            self.win.destroy()
    ...
    def __init__(self):
        ...
        Label(self.win, text='VivaVox' , font=('arial black',20),fg='white',bg='orange').place(x=260,y=50)
